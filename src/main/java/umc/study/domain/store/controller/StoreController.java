...
public class StoreController {
    ...
    public ApiResponse<MissionPreViewListByStoreDTO> getMissions (@PathVariable(name = "storeId") Long storeId, @RequestParam(name = "page", defaultValue = "0") Integer page){
        MissionPreViewListByStoreDTO missions = storeService.getMissionList(storeId,page);
